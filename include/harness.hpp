...
public:
    ...
    Harness(int _m, int _n, int _k, int _runs, T _alpha, T _beta, GemmFunctionPointer<T> _funcPtr, std::string _label) : m(_m), n(_n), k(_k), runs(_runs), alpha(_alpha), beta(_beta), funcPtr(_funcPtr), test_label(_label) { m_monitor = new PerfEvent(); }
...
public:
    ...
    KokkosHarness(int _m, int _n, int _k, int _runs, T _alpha, T _beta, KokkosGemmPtr<T> _funcPtr, std::string _label) : m(_m), n(_n), k(_k), runs(_runs), alpha(_alpha), beta(_beta), funcPtr(_funcPtr), test_label(_label) { m_monitor = new PerfEvent(); }
    BenchmarkResult RunBenchmark();
